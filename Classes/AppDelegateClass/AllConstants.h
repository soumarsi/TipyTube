...
//Api Url
#define API_URL    @"http://www.tipytube.com/api/index.php/"
#define MAIN_URL   @"http://www.tipytube.com/"
#define IMAGES_URL @"http://www.tipytube.com/images/"
#define USER_FILES_URL @"http://www.tipytube.com/userfiles/"
...
extern NSString *const METHOD_GET_FBID_PROFILEID; 
extern NSString *const METHOD_GET_USER_CREDIT_BALANCE;
extern NSString *const METHOD_GET_CREDIT_PACKAGES;
extern NSString *const METHOD_GET_FUNDING_CAMPAIGNS_COUNT;
extern NSString *const METHOD_GET_FUNDING_CAMPAIGNS;
extern NSString *const METHOD_GETPROFILE_PHOTOS;
extern NSString *const METHOD_GETPROFILE_PHOTOS_COUNT;
...
extern NSString *const PARAM_ENT_USER_PROFILE_ID;//ent_user_fbid
