...
-(IBAction)btnAction:(id)sender
{
    ...
    switch (btn.tag)
    {
        ...
        case HOME:{
            ...
            [afn getDataFromPath:@"getFundingCampaignsCountFBId" withParamData:dictParam withBlock:^(id response, NSError *error)
             {
                 if (response)
                 {
                     int campcount = [response[@"count"] intValue];
                     ...
                     {
                         SelectWishizViewController *c = [[SelectWishizViewController alloc] initWithNibName:@"SelectWishizViewController" bundle:nil];
